...
public partial class KoiCareSystemAtHomeDbContext : DbContext
{
    public KoiCareSystemAtHomeDbContext()
    {
    }

    public KoiCareSystemAtHomeDbContext(DbContextOptions<KoiCareSystemAtHomeDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccId).HasName("PK__account___A471AFDA83AC9143");
        ...
        {
            entity.HasKey(e => new { e.AccId, e.ProductId }).HasName("PK__cart_tbl__16A0A2CC4B8637CE");
        ...
        {
            entity.HasKey(e => e.ChartId).HasName("PK__koi_grow__D7FFC8C2D3614B76");
        ...
        {
            entity.HasKey(e => e.KoiId).HasName("PK__kois_tbl__915924CF51659D7E");
        ...
        {
            entity.HasKey(e => e.NoteId).HasName("PK__notes_tb__03C97EFD2DAFBCC0");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ProductId }).HasName("PK__order_de__BAD83E4BFAD5EBA1");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders_t__0809335DD060ACAD");
        ...
        {
            entity.HasKey(e => e.PondId).HasName("PK__ponds_tb__74327499B7C4F2BD");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__2D10D16A2080171E");
        ...
        {
            entity.HasKey(e => e.TokenId).HasName("PK__refresh___AC16DB47F17E67EB");
        ...
        {
            entity.HasKey(e => e.ShopId).HasName("PK__shops_tb__E5C424DCC48ECCCB");
        ...
        {
            entity.HasKey(e => e.ParameterId).HasName("PK__water_pa__F762666B727129AC");
